...
<html xmlns='http://www.w3.org/1999/xhtml' lang='es'>
  ...
  <form method="post" action="editar_2.php">
        <label for="identificador_pelicula">Identificador de Película:</label>
        <input type="text" name="identificador_pelicula" id="identificador_pelicula">
        <br><br>
